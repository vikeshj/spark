...
//  spark
//
//  Created by Vikesh on 15/10/2016.
...
@IBDesignable open class SVGPlayButton: UIButton {
    ...
    @IBInspectable open var progressTrackColor: UIColor = UIColor.white
    
    @IBInspectable open var playColor: UIColor = UIColor.white
    
    @IBInspectable open var pauseColor: UIColor = UIColor.white
